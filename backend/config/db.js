...
=======
// ── Background Seeder (runs AFTER server is ready — non-blocking) ──────────
>>>>>>> Stashed changes
...
=======
                { title: 'Annual Tech Symposium 2026', description: 'The biggest technology gathering on campus!', date: day(7), location: 'Main Auditorium', category: 'Academic', capacity: 500, registrationDeadline: day(5), status: 'Approved', image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80' },
                { title: 'Campus Music Festival', description: 'A vibrant night of live performances.', date: day(14), location: 'Open Air Theater', category: 'Music', capacity: 1000, registrationDeadline: day(10), status: 'Approved', image: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800&q=80' },
                { title: 'Spring Career Fair 2026', description: 'Connect with 80+ top companies.', date: day(20), location: 'Student Center Hall', category: 'Career', capacity: 600, registrationDeadline: day(17), status: 'Approved', image: 'https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=800&q=80' },
                { title: 'Intramural Basketball Finals', description: 'Campus championship game!', date: day(28), location: 'Sports Complex Arena', category: 'Sports', capacity: 800, registrationDeadline: day(26), status: 'Approved', image: 'https://images.unsplash.com/photo-1546519638-68e109498ffc?w=800&q=80' },
                { title: 'Hackathon 2026: Build for Impact', description: '24-hour coding marathon!', date: day(60), location: 'Faculty of Computing Labs', category: 'Tech', capacity: 250, registrationDeadline: day(55), status: 'Approved', image: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=800&q=80' },
                { title: 'AI & Machine Learning Conference 2026', description: 'Premium 2-day AI conference.', date: day(15), location: 'Convention Centre, Block A', category: 'Tech', capacity: 300, registrationDeadline: day(12), status: 'Approved', image: 'https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=800&q=80', ticketing: { regularPrice: 1500, vipPrice: 3500 } },
                { title: 'Electronic Music & Arts Festival', description: '6-hour outdoor EDM festival.', date: day(55), location: 'University Sports Grounds', category: 'Music', capacity: 2000, registrationDeadline: day(50), status: 'Approved', image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800&q=80', ticketing: { regularPrice: 2000, vipPrice: 4500 } },
>>>>>>> Stashed changes
            ];
...
=======
    ...
    // Run seeding in background — server starts immediately
>>>>>>> Stashed changes
