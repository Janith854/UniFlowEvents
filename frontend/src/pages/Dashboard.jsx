            ...
            <main className="pt-24 px-4 pb-16">
                <div className="w-full max-w-6xl mx-auto">
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <Link to="/admin/food" className="bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:bg-gray-100 transition-colors no-underline">
                            <h2 className="font-semibold text-gray-900 mb-2">🍔 Food Management</h2>
                            <p className="text-sm text-gray-600">Manage live orders and monitor analytics.</p>
                        </Link>
                        ...
                        <Link to="/admin/inventory" className="bg-gray-50 border border-gray-200 rounded-2xl p-6 hover:bg-gray-100 transition-colors no-underline">
                            <h2 className="font-semibold text-gray-900 mb-2">📦 Inventory Management</h2>
                            <p className="text-sm text-gray-600">Add new items and edit active menu stock.</p>
                        </Link>
